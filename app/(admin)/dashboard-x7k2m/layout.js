...
function Nav() {
  ...
  return (
    <>
      ...
      {/* Mobile top bar */}
      <header className="md:hidden bg-[#1a2538] border-b border-[#2c3d5e] px-4 py-3 flex items-center justify-between">
        <div>
          <span className="text-[#f0ede8] font-semibold text-sm">BasiQ</span>
          <span className="text-[#344060] mx-2">·</span>
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            onClick={logout}
            className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs text-[#6a7a90] hover:bg-[#253450] hover:text-[#f0ede8] transition-all"
          >
            <span>🚪</span>
          </button>
        </div>
